...
class Movie < ActiveRecord::Base
  ...
  scope :movies_by_average_rating,Movie.where('average_rating IS NOT NULL').order('updated_at DESC').limit(5)
  scope :movies_by_average_rating_men,Movie.where('average_rating IS NOT NULL').order('updated_at DESC').limit(5)
  scope :movies_by_average_rating_women,Movie.where('average_rating IS NOT NULL').order('updated_at DESC').limit(5)
